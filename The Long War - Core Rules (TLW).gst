...
<gameSystem id="5a96-11db-b761-54f0" name="The Long War (TLW)" revision="3" battleScribeVersion="2.03" authorName="Thanathoum" authorContact="" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <profileTypes>
    ...
    <profileType id="a36b-d7d4-4249-a209" name="3. Wargear">
      <characteristicTypes>
...
●Aircraft do not make Panic tests.</description>
    ...
    <categoryEntry id="62a1-35b7-454b-476d" name="Unique" hidden="false"/>
    <categoryEntry id="011e-85a1-b276-91fb" name="Fly" hidden="false"/>
    <categoryEntry id="e936-2227-6105-665c" name="Dedicated Transport" hidden="false"/>
  ...
  <sharedSelectionEntries>
    <selectionEntry id="fa82-ca73-f268-7856" name="Close Combat Weapon" hidden="false" collective="false" import="true" type="upgrade">
      <infoLinks>
        <infoLink id="430e-82cb-ffb8-adf9" name="Close Combat Weapon" hidden="false" targetId="b814-6941-df17-3d2b" type="profile"/>
      </infoLinks>
      <costs>
        <cost name="Pts" typeId="7ba4-038e-f27f-d5ad" value="0.0"/>
      </costs>
    </selectionEntry>
  </sharedSelectionEntries>
  <sharedRules>
...
If rolling to Penetrate against an Armour Value, the weapons attack against the target is resolved with +1 to the weapons Strength characteristic for determining if the weapon caused a Penetrating hit.</description>
    ...
    <rule id="6c30-6668-d067-df6a" name="Variable" hidden="false">
      <description>When firing this weapon, you must select which mode you will use for that attack.</description>
    </rule>
    <rule id="262a-9818-211f-ddc5" name="Combi" hidden="false">
      <description>A weapon with this trait is made of two weapons. You do not require the Firing Protocols special rule to fire both weapons in a shooting phase however and are treated as one weapon for all other purposes.</description>
    </rule>
  </sharedRules>
  <sharedProfiles>
